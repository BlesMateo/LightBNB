...
VALUES (1, 3, 'Office', 'Spy Agency', 'img/office_thumb.png', 'img/office.png', 800, 20, 10, 4, 'United States', 'New York Street', 'New York', 'New York', 'asdfhgdrt', TRUE),
(2, 3, 'Apartment', 'High end dwelling', 'img/apartment_thumb.png', 'img/apartment.png', 1000, 2, 2, 2, 'Canada', 'Truckasaurus Street', 'Ottawa', 'Ontario', 'asdfhgdrt', TRUE),
(3, 3, 'Penthouse', 'Affluent Living Space', 'img/penthouse_thumb.png', 'img/penthouse.png', 3000, 5, 5, 5, 'Tunisia', 'Martini Street', 'Bourbon', 'Ben Arous', 'asdfhgdrt', TRUE);
